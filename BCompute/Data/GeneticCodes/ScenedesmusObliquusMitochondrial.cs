...
{
    public static class ScenedesmusObliquusMitochondrial
    {
        public const int NcbiTranslationTable = (int)GeneticCode.ScenedesmusObliquusMitochondrial;
            ...
            get
            {
                if (_transcriptionTable == null)
                {
                    var codons = new Dictionary<string, ProteinType>
                    {
                        ...
                        {"TCA", ProteinType.Stop},
                        {"TAG", ProteinType.Leucine},
                    };
