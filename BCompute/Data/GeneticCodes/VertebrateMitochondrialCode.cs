...
{
    public static class VertebrateMitochondrialCode
    {
        //http://www.ncbi.nlm.nih.gov/Taxonomy/Utils/wprintgc.cgi

        public const int NcbiTranslationTable = (int)GeneticCode.VertebrateMitochondria;
