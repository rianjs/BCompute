...
{
    public static class CiliateDasycladaceanHexamita
    {
        public const int NcbiTranslationTable = (int) GeneticCode.CiliateDasycladaceanHexamita;
