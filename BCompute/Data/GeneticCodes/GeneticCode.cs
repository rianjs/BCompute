namespace BCompute.Data.GeneticCodes
{
    ...
    {
        Standard = 1,
        VertebrateMitochondria = 2,
        YeastMitochondrial = 3,
        MoldProtozoanCoelenterateMitochondrialAndMycoplasmaSpiroplasma = 4,
        InvertebrateMitochrondria = 5,
        ...
        CandidateDivisionSr1AndGracilibacteria = 25,
    }
}
